...
int main()
{
	...
	while(flag!=0)
	{
		...
		cout<<"Press 2 -> display_data Data                 "<<end;
...
void books::read_data()
{
		cout<<"Enter title, author, publisher, price and stock of the book"<<endl;
		gets(a.name); gets(a.auth); gets(a.publ); cin>>a.price>>a.stock;
}

void books::display_data_single();
{
		cout<<"Title : "; puts(a.name); cout<<endl;
		cout<<"Author : "; puts(a.auth); cout<<endl;
		cout<<"Publisher : "; puts(a.publ); cout<<endl;
		cout<<"Price : "<<a.price<<endl;
		cout<<"Stock : "<<a.stock<<endl;
}

void books::display_data_multiple(int rank)
{
	cout<<endl<<rank;
	cout<<"Title : "; puts(a.name); cout<<endl;
	cout<<"Author : "; puts(a.auth); cout<<endl;
